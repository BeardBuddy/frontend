...
import { MemoryProvider } from "@/lib/store/store";
import Dashboard from "@/components/Dashboard";
import BookingWizard from "@/components/BookingWizard";
import ShinyText from "@/common/components/ShinyText";
import { Scissors, Calendar, LayoutDashboard } from "lucide-react";
  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col">
        {activeTab === "dashboard"
          ? <Dashboard onStartBooking={() => setActiveTab("booking")} />
          : <BookingWizard onCancelBooking={() => setActiveTab("dashboard")} />
        }
      </main>
    </>
  );
